    ...
    >
      <div className="container mx-auto mb-10">
        <div className="flex flex-col gap-3 xl:mb-10 pb-10 align-middle justify-center content-center items-center mx-auto text-center">
          <h1 className=" text-accent text-[50px]">
            Réservez votre ImmersivBox
          </h1>
          <h2 className=" text-accent text-[25px]">
            Contactez-nous pour découvrir comment l'ImmersivBox peut transformer
            vos ventes.
          </h2>
        </div>
        ...
        <div className="flex flex-col xl:flex-row gap-12 mt-5">
          ...
          <div className="xl:h-[54%] flex-1 order-2 xl:order-none">
            <form className="flex flex-col gap-6 mb-5 " onSubmit={handleSubmit}>
                ...
                {info.map((inf, index) => {
                  return (
                    <li key={index} className="flex items-center gap-5">
                      <div className="w-[52px] h-[52px] xl:w-[72px] xl:h-[72px] bg-[#272727] text-white rounded-md flex items-center justify-center">
                        <div>{inf.icon}</div>
                      </div>
                      <div>
